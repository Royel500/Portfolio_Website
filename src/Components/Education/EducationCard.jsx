...
const EducationCard = ({ data }) => {
  ...
  return (
    <div className={`rounded-3xl   hover:shadow-fuchsia-700 transition-transform duration-300 
    hover:scale-95 shadow-md overflow-hidden ${cardBg}`}>
      <div className="p-6">
        <div className="flex items-start mb-6">
          <div className="bg-gray-400 p-3 rounded-lg mr-4 shadow-sm">
            {CardIcon && <CardIcon className="text-blue-600 text-2xl" />}
          </div>
          <div className='bg-gray-400 px-2 rounded'>
        ...
        <div className="border-t border-gray-200 pt-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            {achievements.map((achievement, index) => {
              ...
              return (
                <div key={index} className="flex items-center bg-gray-400 bg-opacity-80 rounded-lg p-2 shadow-sm">
