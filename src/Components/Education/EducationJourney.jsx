...
const EducationJourney = () => {
  const educationCardsData = [
    {
      ...
      years: "2021 - 2023",
      icon: FaSchool,
      cardBg: "bg-blue-300", // Added background color
      achievements: [
    ...
    },
    {
      ...
      cardBg: "bg-green-200", // Added background color
      achievements: [
  ...
  return (
    <section className="min-h-screen my-10 rounded-2xl py-16 px-4 bg-gray-700">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-pink-500  text-center mb-4 ">
          Education Journey
        </h1>
